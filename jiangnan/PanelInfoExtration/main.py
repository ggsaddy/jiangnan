...
if __name__ == '__main__':
    ...
    panel_path = "STR_DRW_CURVE_INFO.xlsx"
    segment_path = "STR_DRW_PANEL_LIMIT_INFO.xlsx"
    # 读取回路曲线组成文件
    ...
    saved_path = save_json_to_file(json_stream, "example_output.json")
    json_stream.seek(0)  # 重置指针以便读取
    
    # 创建包含标注数据的表格对象
    Panel_Anno_Info = PanelAnno()
    # 生成Excel文件
    create_anno_excel(Panel_Anno_Info, "output/example.xlsx")
