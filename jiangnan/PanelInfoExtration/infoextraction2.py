...
from PanelInfoExtration.plot_geo import plot_geometry,plot_polys, plot_info_poly,p_minus,p_add,p_mul
import os
from PanelInfoExtration.utils import segment_intersection_line,segment_intersection,computeBoundingBox,is_parallel,conpute_angle_of_two_segments,point_segment_position,shrinkFixedLength,check_points_against_segments,check_points_against_free_segments,check_parallel_anno,check_vertical_anno,check_non_parallel_anno,check_whole
from PanelInfoExtration.classifier import poly_classifier,match_template,load_classification_table,eva_c_f,poly_classifier_ustd
from scipy.spatial import ConvexHull
import matplotlib.pyplot as plt
from shapely.geometry import Point, Polygon, LineString
from PanelInfoExtration.bracket_parameter_extraction import parse_elbow_plate
import json
import re
import numpy as np
import csv
