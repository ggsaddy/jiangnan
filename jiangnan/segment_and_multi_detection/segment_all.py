...
from segment_and_multi_detection.segment.main import segment_v4
from segment_and_multi_detection.split.main import multi_detect
...
def segment_all_main(input_file,input_folder,output_folder):
    ...
    print("segment start .....")
    bbox_list=segment_v4(json_file,img_file)
    print(bbox_list)
    if len(bbox_list)!=0:
...
def main(input_folder,output_folder):
    ...
    for input_file in input_list:
        try:
            ...
            pass
        result_mergerd_bbox_list=segment_all_main(input_file, input_folder, output_folder)
